...
<template>
	<view class="page">
		...
		<image src="../../static/images/icon-close-black.png" style="width: 50rpx;height: 50rpx;" @click="close()">
		</image>
		...
		<view class="login-box">
			...
			<view class="mobile-box">
				...
				<input type="number" class="mobile" :value="mobile" :model="mobile" @input="typingMobile"
					placeholder="请输入手机号" maxlength="11" style="align-self: center;" />
			</view>
			<view class="line" style="height: 1rpx;background-color: #afafb3;"></view>

			<view class="mobile-box" style="margin-top: 20rpx;">
				<input type="number" class="mobile" :value="verifyCode" :model="verifyCode" @input="typingVerifyCode"
					placeholder="请输入验证码" maxlength="6" style="width: 360rpx;align-self: center;" />

				<view class="middle" style="align-self: center;"></view>

				<view :class="{'btn-code':!codeTouched, 'btn-code-touched': codeTouched}" @touchstart="touchstartCode"
					@touchend="touchendCode" @click="getCode()"
			...
			<view :class="{'btn-login':!loginTouched, 'btn-login-touched': loginTouched}" @touchstart="touchstartLogin"
				@touchend="touchendLogin" @click="loginOrRegist()"
	...
	export default {
		...
		methods: {
			...
			getCode() {
				...
				uni.request({
					method: "POST",
					url: serverUrl + "/user/getSMSCode?phone=" + mobile,
					success(result) {
