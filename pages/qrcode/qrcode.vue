...
<template>
	<view class="page">
		...
		<view class="qrcode-box" style="width: 550rpx;height: 700rpx;margin-top: 320rpx;align-self: center;">
			...
			<view class="user-box">
				<image mode="aspectFill" class="bg-cover"
					style="width: 130rpx;height: 130rpx;border-radius: 100px;align-self: center;"
					:src="pageUserInfo.face"></image>
				<text
					style="align-self: center; margin-top: 10rpx;font-size: 14px;font-weight: 400;">{{pageUserInfo.nickname}}</text>
				...
				<text
					style="align-self: center; margin-top: 20rpx;color: #808080;font-size: 11px;font-weight: 300;">扫描二维码，就能看我的作品哟</text>
			</view>
...
<script>
	...
	export default {
		...
		onShow() {
			...
			uni.request({
				method: "GET",
				url: serverUrl + "/user/queryByVlogId?vlogId=" + this.vlogId,
				success(result) {
